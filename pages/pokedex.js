...
export default function Home() {
    ...
    return (
        <div>
            ...
            <div className='px-4 py-12 dark:bg-gray-900'>
                ...
                <div className='mt-12 block sm:flex sm:justify-end sm:items-center sm:mr-12'>
                    {(term || pokemons.length!==807) && <div onClick={clear} className='cursor-pointer py-1 bg-blue-500 text-white px-2 rounded mb-4 sm:mb-0 text-center'>Clear filters</div>}
